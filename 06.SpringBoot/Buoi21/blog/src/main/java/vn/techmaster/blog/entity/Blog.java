...
@SqlResultSetMapping(name = "listBlogInfo", classes = @ConstructorResult(targetClass = BlogInfo.class,
...
@NamedNativeQuery(name = "getAllBlogInfo", resultSetMapping = "listBlogInfo",
...
public class Blog {
    ...
    @ManyToMany
    @JoinTable(name = "blog_categories", joinColumns = @JoinColumn(name = "blog_id"),
