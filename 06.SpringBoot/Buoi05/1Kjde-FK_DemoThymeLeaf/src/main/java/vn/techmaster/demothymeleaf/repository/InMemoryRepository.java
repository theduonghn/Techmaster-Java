...
public class InMemoryRepository {
  ...
  public InMemoryRepository() {
    ...
    jobs.put("es", List.of(
        new Job("es", "doctor", "doctora"),
        new Job("es", "engineer", "ingeniera"),
        new Job("es", "staff", "personal"),
        new Job("es", "teacher", "profesora")));
  }
  ...
  public List<Job> getJobsByLanguage(String language) {
    return jobs.get(language);
  }
}
